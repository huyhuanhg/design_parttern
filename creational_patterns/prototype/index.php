...
function clientCode()
{
    ...
    if ($p1->primitive === $p2->primitive) {
        echo "<b>Primitive field values have been carried over to a clone. Yay!</b><br />";
    } else {
        echo "<b>Primitive field values have not been copied. Booo!</b><br />";
    }

    var_dump($p1->component, $p2->component);

    if ($p1->component === $p2->component) {
        echo "<b>Simple component has not been cloned. Booo!</b><br />";
    } else {
        echo "<b>Simple component has been cloned. Yay!</b><br />";
    }

    var_dump($p1->circularReference, $p2->circularReference);

    if ($p1->circularReference === $p2->circularReference) {
        echo "<b>Component with back reference has not been cloned. Booo!</b><br />";
    } else {
        echo "<b>Component with back reference has been cloned. Yay!</b><br />";
    }

    var_dump($p1->circularReference->prototype, $p2->circularReference->prototype);

    if ($p1->circularReference->prototype === $p2->circularReference->prototype) {
        echo "<b>Component with back reference is linked to original object. Booo!</b><br />";
    } else {
        echo "<b>Component with back reference is linked to the clone. Yay!</b><br />";
    }
}
